...
const greeting = {
  username: "Rajnish Yadav",
  title: "Rajnish here",
  subTitle: emoji(
    "A passionate Fullstack Blockchain developer having an experience in working cross functional team and building Web3 Application  with Web3js , Reactjs , Nodejs , Solidity and some other cool ❄️ libraries and frameworks."
  ),
  resumeLink:
